...
def extract_label(label_item: dict) -> str:
    ...
    raise KeyError("Each label item must contain either 'label' or 'output'.")


def main() -> None:
    current_dir = Path(__file__).resolve().parent
    test_path = current_dir / "cwru_test.json"
    labels_path = current_dir / "cwru_labels.json"
    output_path = current_dir / "cwru_test_with_labels.json"
